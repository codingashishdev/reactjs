...
function Card({allSubjects, name}) {
    return (
        <>
            <div className=" w-100 flex flex-col rounded-xl glass min-h-72 mt-3 overflow-hidden">
                <div>
                    <img
                ...
                <div className="flex flex-col py-3 px-3 pb-7 -mt-4 bg-black rounded-b-xl ">
                    ...
                    <div className="flex  justify-between fon`t-mono">
                        <p>#345</p>
                        <p>0.01</p>
                    </div>
                </div>
